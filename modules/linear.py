...
class Linear(object):
    ...
    def __init__(self, in_size, out_size, bias=True, debug=False):
        ...
        self.logger.debug('W ', self.w.shape)
        self.logger.debug('dw ', self.dL_dw.shape)
    ...
    def backward (self, dL_ds):
        ...
        self.logger.debug('Backward | dL_x0:', dL_x0)
        return dL_x0
